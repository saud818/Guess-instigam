...
if __name__ == "__main__":
        try:
                ...
                banner = f'''
{rdm} __  __ ___ ___
{rdm}|🕷️ \/  | _ )_ _ |{W + B}| Author  : Mohamed Åhssine
{rdm}|🕷️|\/| | _ \| |  {W + B}| Github : spider-fb 🕸️🕷️🕸️
{rdm}|_|  |_|___/___| {W + B}| Bismilah dulu Goblok -                                                          
- {R + D} Marocain{W + B} hackér{C}
                '''
                print(banner)
                print("1. Search username by query 🔂")
                print("2. Search username by multipel query🔁")
                print("3. Search username by random name🔀")
                print("4. Search username by #hastag⏭️")
                print("5. Search username by multipel #hastag⏭️")
